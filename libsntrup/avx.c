...
static void mult8_nega_over65536_x16(int16x16 h[8],const int16x16 f[8],const int16x16 g[8], char *_buffer)
{
  /* strategy: reduced refined Karatsuba */
  /* 176 mul + 159 add */
#ifdef _USE_LESS_STACK_
  //char * _buffer = aligned_alloc(32,29*32);
  int16x16 *fmid = (int16x16*)(_buffer+0*32);
  int16x16 *gmid = (int16x16*)(_buffer+4*32);
  int16x16 *hbot = (int16x16*)(_buffer+8*32);
  int16x16 *hmid = (int16x16*)(_buffer+15*32);
  int16x16 *htop = (int16x16*)(_buffer+22*32);
#else
  int16x16 fmid[4],gmid[4],hbot[7],hmid[7],htop[7]
#endif
  int16x16 c0,c1,c2,c3,d0,d1,d2,d3;
...
void fft64(int16x16 fpad[16*8],const int16x16 f[64])
{
  ...
  int16x16 a40 = f[32];
  int16x16 a44 = f[36];
  fpad[0*8+0] = add_x16(a00,a04);
  fpad[4*8+0] = sub_x16(a00,a04);
  fpad[0*8+4] = add_x16(a40,a44);
  fpad[4*8+4] = sub_x16(a40,a44);
  fpad[8*8+0] = sub_x16(a00,a44);
  fpad[12*8+0] = add_x16(a00,a44);
  fpad[8*8+4] = add_x16(a40,a04);
  fpad[12*8+4] = sub_x16(a40,a04);

  int16x16 a01 = f[1];
  int16x16 a05 = f[5];
  int16x16 a41 = f[33];
  int16x16 a45 = f[37];
  fpad[1*8+0] = add_x16(a01,a05);
  fpad[5*8+2] = sub_x16(a01,a05);
  fpad[1*8+4] = add_x16(a41,a45);
  fpad[5*8+6] = sub_x16(a41,a45);
  fpad[13*8+7] = neg_x16(add_x16(a01,a45));
  fpad[9*8+1] = sub_x16(a01,a45);
  fpad[13*8+3] = sub_x16(a41,a05);
  fpad[9*8+5] = add_x16(a41,a05);

  int16x16 a02 = f[2];
  int16x16 a06 = f[6];
  int16x16 a42 = f[34];
  int16x16 a46 = f[38];
  fpad[2*8+0] = add_x16(a02,a06);
  fpad[6*8+4] = sub_x16(a02,a06);
  fpad[2*8+4] = add_x16(a42,a46);
  fpad[6*8+0] = sub_x16(a46,a42);
  fpad[14*8+6] = neg_x16(add_x16(a02,a46));
  fpad[10*8+2] = sub_x16(a02,a46);
  fpad[14*8+2] = sub_x16(a42,a06);
  fpad[10*8+6] = add_x16(a42,a06);

  int16x16 a03 = f[3];
  int16x16 a07 = f[7];
  int16x16 a43 = f[35];
  int16x16 a47 = f[39];
  fpad[3*8+0] = add_x16(a03,a07);
  fpad[7*8+6] = sub_x16(a03,a07);
  fpad[3*8+4] = add_x16(a43,a47);
  fpad[7*8+2] = sub_x16(a47,a43);
  fpad[15*8+5] = neg_x16(add_x16(a03,a47));
  fpad[11*8+3] = sub_x16(a03,a47);
  fpad[15*8+1] = sub_x16(a43,a07);
  fpad[11*8+7] = add_x16(a43,a07);
  ...
  int16x16 a60 = f[48];
  int16x16 a64 = f[52];
  fpad[0*8+2] = add_x16(a20,a24);
  fpad[4*8+2] = sub_x16(a20,a24);
  fpad[0*8+6] = add_x16(a60,a64);
  fpad[4*8+6] = sub_x16(a60,a64);
  fpad[8*8+2] = sub_x16(a20,a64);
  fpad[12*8+2] = add_x16(a20,a64);
  fpad[8*8+6] = add_x16(a60,a24);
  fpad[12*8+6] = sub_x16(a60,a24);

  int16x16 a21 = f[17];
  int16x16 a25 = f[21];
  int16x16 a61 = f[49];
  int16x16 a65 = f[53];
  fpad[1*8+2] = add_x16(a21,a25);
  fpad[5*8+4] = sub_x16(a21,a25);
  fpad[1*8+6] = add_x16(a61,a65);
  fpad[5*8+0] = sub_x16(a65,a61);
  fpad[9*8+3] = sub_x16(a21,a65);
  fpad[13*8+1] = add_x16(a21,a65);
  fpad[9*8+7] = add_x16(a61,a25);
  fpad[13*8+5] = sub_x16(a61,a25);

  int16x16 a22 = f[18];
  int16x16 a26 = f[22];
  int16x16 a62 = f[50];
  int16x16 a66 = f[54];
  fpad[2*8+2] = add_x16(a22,a26);
  fpad[6*8+6] = sub_x16(a22,a26);
  fpad[2*8+6] = add_x16(a62,a66);
  fpad[6*8+2] = sub_x16(a66,a62);
  fpad[10*8+4] = sub_x16(a22,a66);
  fpad[14*8+0] = add_x16(a22,a66);
  fpad[10*8+0] = neg_x16(add_x16(a62,a26));
  fpad[14*8+4] = sub_x16(a62,a26);

  int16x16 a23 = f[19];
  int16x16 a27 = f[23];
  int16x16 a63 = f[51];
  int16x16 a67 = f[55];
  fpad[3*8+2] = add_x16(a23,a27);
  fpad[7*8+0] = sub_x16(a27,a23);
  fpad[3*8+6] = add_x16(a63,a67);
  fpad[7*8+4] = sub_x16(a67,a63);
  fpad[11*8+5] = sub_x16(a23,a67);
  fpad[15*8+7] = neg_x16(add_x16(a23,a67));
  fpad[11*8+1] = neg_x16(add_x16(a63,a27));
  fpad[15*8+3] = sub_x16(a63,a27);
  ...
  int16x16 a50 = f[40];
  int16x16 a54 = f[44];
  fpad[0*8+1] = add_x16(a10,a14);
  fpad[4*8+1] = sub_x16(a10,a14);
  fpad[0*8+5] = add_x16(a50,a54);
  fpad[4*8+5] = sub_x16(a50,a54);
  fpad[8*8+1] = sub_x16(a10,a54);
  fpad[12*8+1] = add_x16(a10,a54);
  fpad[8*8+5] = add_x16(a50,a14);
  fpad[12*8+5] = sub_x16(a50,a14);

  int16x16 a11 = f[9];
  int16x16 a15 = f[13];
  int16x16 a51 = f[41];
  int16x16 a55 = f[45];
  fpad[1*8+1] = add_x16(a11,a15);
  fpad[5*8+3] = sub_x16(a11,a15);
  fpad[1*8+5] = add_x16(a51,a55);
  fpad[5*8+7] = sub_x16(a51,a55);
  fpad[9*8+2] = sub_x16(a11,a55);
  fpad[13*8+0] = add_x16(a11,a55);
  fpad[9*8+6] = add_x16(a51,a15);
  fpad[13*8+4] = sub_x16(a51,a15);

  int16x16 a12 = f[10];
  int16x16 a16 = f[14];
  int16x16 a52 = f[42];
  int16x16 a56 = f[46];
  fpad[2*8+1] = add_x16(a12,a16);
  fpad[6*8+5] = sub_x16(a12,a16);
  fpad[2*8+5] = add_x16(a52,a56);
  fpad[6*8+1] = sub_x16(a56,a52);
  fpad[10*8+3] = sub_x16(a12,a56);
  fpad[14*8+7] = neg_x16(add_x16(a12,a56));
  fpad[10*8+7] = add_x16(a52,a16);
  fpad[14*8+3] = sub_x16(a52,a16);

  int16x16 a13 = f[11];
  int16x16 a17 = f[15];
  int16x16 a53 = f[43];
  int16x16 a57 = f[47];
  fpad[3*8+1] = add_x16(a13,a17);
  fpad[7*8+7] = sub_x16(a13,a17);
  fpad[3*8+5] = add_x16(a53,a57);
  fpad[7*8+3] = sub_x16(a57,a53);
  fpad[11*8+4] = sub_x16(a13,a57);
  fpad[15*8+6] = neg_x16(add_x16(a13,a57));
  fpad[11*8+0] = neg_x16(add_x16(a53,a17));
  fpad[15*8+2] = sub_x16(a53,a17);
  ...
  int16x16 a70 = f[56];
  int16x16 a74 = f[60];
  fpad[0*8+3] = add_x16(a30,a34);
  fpad[0*8+7] = add_x16(a70,a74);
  fpad[4*8+3] = sub_x16(a30,a34);
  fpad[4*8+7] = sub_x16(a70,a74);
  fpad[8*8+3] = sub_x16(a30,a74);
  fpad[8*8+7] = add_x16(a70,a34);
  fpad[12*8+3] = add_x16(a30,a74);
  fpad[12*8+7] = sub_x16(a70,a34);

  int16x16 a31 = f[25];
  int16x16 a35 = f[29];
  int16x16 a71 = f[57];
  int16x16 a75 = f[61];
  fpad[1*8+3] = add_x16(a31,a35);
  fpad[1*8+7] = add_x16(a71,a75);
  fpad[5*8+5] = sub_x16(a31,a35);
  fpad[5*8+1] = sub_x16(a75,a71);
  fpad[9*8+4] = sub_x16(a31,a75);
  fpad[9*8+0] = neg_x16(add_x16(a71,a35));
  fpad[13*8+2] = add_x16(a31,a75);
  fpad[13*8+6] = sub_x16(a71,a35);

  int16x16 a32 = f[26];
  int16x16 a36 = f[30];
  int16x16 a72 = f[58];
  int16x16 a76 = f[62];
  fpad[2*8+3] = add_x16(a32,a36);
  fpad[2*8+7] = add_x16(a72,a76);
  fpad[6*8+7] = sub_x16(a32,a36);
  fpad[6*8+3] = sub_x16(a76,a72);
  fpad[10*8+5] = sub_x16(a32,a76);
  fpad[10*8+1] = neg_x16(add_x16(a72,a36));
  fpad[14*8+1] = add_x16(a32,a76);
  fpad[14*8+5] = sub_x16(a72,a36);

  int16x16 a33 = f[27];
  int16x16 a37 = f[31];
  int16x16 a73 = f[59];
  int16x16 a77 = f[63];
  fpad[3*8+3] = add_x16(a33,a37);
  fpad[3*8+7] = add_x16(a73,a77);
  fpad[7*8+1] = sub_x16(a37,a33);
  fpad[7*8+5] = sub_x16(a77,a73);
  fpad[11*8+6] = sub_x16(a33,a77);
  fpad[11*8+2] = neg_x16(add_x16(a73,a37));
  fpad[15*8+0] = add_x16(a33,a77);
  fpad[15*8+4] = sub_x16(a73,a37);

  for (i = 0;i < 16;i += 4) {
    for (j = 0;j < 4;++j) {
      int16x16 a = fpad[(i)*8+j];
      int16x16 c = fpad[(i+2)*8+j];
      int16x16 A = fpad[(i)*8+j+4];
      int16x16 C = fpad[(i+2)*8+j+4];
      int16x16 r = add_x16(a,c);
      int16x16 s = add_x16(A,C);
      int16x16 b = fpad[(i+1)*8+j];
      int16x16 d = fpad[(i+3)*8+j];
      int16x16 B = fpad[(i+1)*8+j+4];
      int16x16 D = fpad[(i+3)*8+j+4];
      ...
      fpad[(i)*8+j] = squeeze13_x16(add_x16(r,R));
      fpad[(i+1)*8+j] = squeeze13_x16(sub_x16(r,R));
      fpad[(i)*8+j+4] = squeeze13_x16(add_x16(s,S));
      fpad[(i+1)*8+j+4] = squeeze13_x16(sub_x16(s,S));
      fpad[(i+2)*8+j] = squeeze13_x16(sub_x16(t,U));
      fpad[(i+2)*8+j+4] = squeeze13_x16(add_x16(u,T));
      fpad[(i+3)*8+j] = squeeze13_x16(add_x16(t,U));
      fpad[(i+3)*8+j+4] = squeeze13_x16(sub_x16(u,T));
    }
  }
}
...
void unfft64_scale16(int16x16 f[64],int16x16 fpad[16*8])
{
  ...
  for (i = 0;i < 16;++i)
    for (j = 0;j < 8;++j)
      assertrange_x16(fpad[(i)*8+j],8000);

  for (i = 0;i < 16;i += 4) {
    for (j = 0;j < 4;++j) {
      int16x16 a = fpad[(i)*8+j];
      int16x16 A = fpad[(i+1)*8+j];
      int16x16 b = fpad[(i)*8+j+4];
      int16x16 B = fpad[(i+1)*8+j+4];
      int16x16 c = fpad[(i+2)*8+j];
      int16x16 d = fpad[(i+2)*8+j+4];
      int16x16 C = fpad[(i+3)*8+j];
      int16x16 D = fpad[(i+3)*8+j+4];
      ...
      fpad[(i)*8+j] = add_x16(r,R);
      fpad[(i+1)*8+j] = add_x16(s,S);
      fpad[(i)*8+j+4] = add_x16(t,T);
      fpad[(i+1)*8+j+4] = add_x16(u,U);
      fpad[(i+2)*8+j] = sub_x16(r,R);
      fpad[(i+3)*8+j] = sub_x16(s,S);
      fpad[(i+2)*8+j+4] = sub_x16(t,T);
      fpad[(i+3)*8+j+4] = sub_x16(u,U);
    }
  }
  ...
  for (i = 0;i < 3;++i) {
    for (j = 0;j < 4;++j) {
      int16x16 a = squeeze13_x16(fpad[(i)*8+j]);
      int16x16 b = squeeze13_x16(fpad[(i)*8+j+4]);
      int16x16 A = squeeze13_x16(fpad[(i+4)*8+j]);
      int16x16 B = squeeze13_x16(fpad[(i+4)*8+j+4]);
      int16x16 c = squeeze13_x16(fpad[(i+8)*8+j]);
      int16x16 d = squeeze13_x16(fpad[(i+8)*8+j+4]);
      int16x16 C = squeeze13_x16(fpad[(i+12)*8+j]);
      int16x16 D = squeeze13_x16(fpad[(i+12)*8+j+4]);
      ...
      fpad[(i)*8+j] = add_x16(r,R);
      fpad[(i)*8+j+4] = add_x16(s,S);
      fpad[(i+4)*8+j] = add_x16(t,T);
      fpad[(i+4)*8+j+4] = add_x16(u,U);
      fpad[(i+8)*8+j] = sub_x16(r,R);
      fpad[(i+8)*8+j+4] = sub_x16(s,S);
      fpad[(i+12)*8+j] = sub_x16(t,T);
      fpad[(i+12)*8+j+4] = sub_x16(u,U);
    }
  }
  for (i = 3;i < 4;++i) {
    for (j = 0;j < 4;++j) {
  ...
  for (i = 0;i < 7;++i) {
    f[i] = squeeze13_x16(sub_x16(fpad[(i)*8+0],fpad[(i+8)*8+7]));
    for (j = 1;j < 8;++j)
      f[i+8*j] = squeeze13_x16(add_x16(fpad[(i)*8+j],fpad[(i+8)*8+j-1]));
  }
  for (i = 7;i < 8;++i) {
    /* y^15 does not appear; i.e., fpad[i+8] is 0 */
    for (j = 0;j < 8;++j)
      f[i+8*j] = squeeze13_x16(fpad[(i)*8+j]);
  }
...
/* output range: +-4000 */
static
void mult64_nega_over4096_x16(int16x16 h[64],const int16x16 f[64],const int16x16 g[64], char *_buffer)
{
...
#ifdef  _USE_LESS_STACK_
  //char * _buffer = aligned_alloc(32,16*8*32*2);
  int16x16 *fpad = (int16x16*)_buffer;
  int16x16 *gpad = (int16x16*)(_buffer+16*8*32);
  _buffer += 256*32;
#else
  int16x16 fpad[16][8];
  int16x16 gpad[16][8];
...
#define hpad fpad
  ...
  for (i = 0;i < 16;++i)
    mult8_nega_over65536_x16(&hpad[i*8],&fpad[i*8],&gpad[i*8], _buffer);
...
void mult768_over64(int16 h[1536],const int16 f[768],const int16 g[768])
{
...
#ifdef  _USE_LESS_STACK_
  char * _buffer = aligned_alloc(32,32*(128*3+32));
  //char * _buffer = aligned_alloc(32,32*64*3);
  int16x16 *ftr = (int16x16*) (_buffer+0*32*64);
  int16x16 *gtr = (int16x16*) (_buffer+1*32*64);
  int16x16 *htr = ftr; //(int16x16*) (_buffer+2*32*64);
#else
  int16x16 ftr[64];
  int16x16 gtr[64];
  int16x16 htr[64];
  ...
  for (i = 0;i < 48;i += 16) {
    ...
    mult64_nega_over4096_x16(htr,ftr,gtr, _buffer+128*32);
...
void polymul(int16_t *des, const int16_t *src1, const int16_t *src2){
    ...
    mult768_over64(buff, src1, src2);

    for(size_t i = p + p - 2; i >= p; i--){
        buff[i - p] = (buff[i - p] + buff[i]);
        buff[i - p + 1] = (buff[i - p + 1] + buff[i]);
    }

    for(size_t i = 0; i < p; i+= 16) {
        montproduct_Rx64_p16( des + i , buff + i );
    }
